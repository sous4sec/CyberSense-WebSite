document.addEventListener("DOMContentLoaded", () => {
    ...
    const contatoButton = document.querySelector(".btn-contato button");
    ...
    menuLinks[2].addEventListener("click", () => scrollToSection(".quem-somos"));
    menuLinks[3].addEventListener("click", () => scrollToSection(".visao-cliente"));
    menuLinks[4].addEventListener("click", () => scrollToSection(".sobre"));

    // Adicionando evento ao botão "Contato"
    contatoButton.addEventListener("click", () => scrollToSection(".formulario"));
